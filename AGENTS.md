...
- Studio hero now fills the full opening behind the header and introduction, like /fivem. Use a strong fading dark overlay at the bottom for project details, and rotate the three projects every five seconds with manual selection and a pause control. This supersedes the previous split-opening/manual-only carousel preference.
